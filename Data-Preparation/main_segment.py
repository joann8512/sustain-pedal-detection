...
if __name__ == "__main__":
    ...
    parser.add_argument("task", type=str, help="[train, inference]")
    args = parser.parse_args()
    
    dataset_name = 'pedal-segment_npydf_small.csv'
    #model_name = args.model_name
    exp_name = 'segment{}_{}'.format(args.model_name, args.exp)
    ...
    for model_name in model_names:
        ...
        exp_name = 'small-segment_{}'.format(args.model_name)
